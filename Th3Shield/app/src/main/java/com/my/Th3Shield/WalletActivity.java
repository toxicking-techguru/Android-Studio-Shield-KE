...
public class WalletActivity extends AppCompatActivity {
	...
	private TextView textviewearningss;
	...
	private DatabaseReference walleti = _firebase.getReference("wallet");
	private ChildEventListener _walleti_child_listener;
	private Intent stk = new Intent();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textviewearningss = findViewById(R.id.textviewearningss);
		imageview1 = findViewById(R.id.imageview1);
		textview1 = findViewById(R.id.textview1);
		textviewmame = findViewById(R.id.textviewmame);
		...
		textviewearningss.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
		...
		_wallet_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					textviewearningss.setText("ksh".concat(String.valueOf((long)(Double.parseDouble(_childValue.get("balance").toString())))));
				}
				else {
		...
		_walleti_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
		...
		walleti.addChildEventListener(_walleti_child_listener);
	...
	private void initializeLogic() {
		textviewmame.setText("Hello".concat(sp.getString("", "").concat("!")));
	}
